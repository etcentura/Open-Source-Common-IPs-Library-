...
py parse_images.py ..\tb_dump_data\checker_horizontal.data 640 512 8 .\images\checker_horizontal.png
...
py parse_images.py ..\tb_dump_data\checker_vertical.data 640 512 8 .\images\checker_vertical.png
py parse_images.py ..\tb_dump_data\checker_xored.data640 512 8 .\images\checker_xored.png